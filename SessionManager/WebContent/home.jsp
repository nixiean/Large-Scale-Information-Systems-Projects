...
<body>
	...
	String sessionIdParam = (String)request.getAttribute("currentSessionId");
	...
	<form action="EnterServlet" method="post">
		...
		<tr><td><input type="submit" name="submit" value="Refresh"></td></tr>
	...
	<h5>Click <a href="./print">here</a> to print all active sessions</h5>
	
	<%
		for(String key : EnterServlet.myView.keySet()) {
			out.println("myViewEntry :" + key + "," + EnterServlet.myView.get(key));
		}
	%>
